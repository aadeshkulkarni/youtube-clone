  ...
  return (
    <div className="fixed bg-white w-full grid grid-flow-col p-4 border-b border-gray-200">
      <div className="col-span-1 flex items-center">
        ...
        <a href="/">
          <img className="cursor-pointer pl-8 w-36" src="./youtube.svg" alt="logo" />
        </a>
      </div>
        ...
        <div className="flex justify-center items-center">
          <div className="relative">
            <div className="flex justify-center items-center">
              ...
              />
              {search !== "" && (
                <div className="z-30 absolute top-3 right-16 font-bold text-gray-500 hover:text-gray-900 cursor-pointer" onClick={() => setSearch("")}>
                  ╳
                </div>
              )}
            ...
            {showSuggestions && suggestions.length > 0 && (
              <>
                ...
                <div className="fixed bg-white py-2 px-4 border border-gray-300 rounded-lg w-[600px] z-20">
                  <ul className="">
